...
export class AdminViewComponent {
  ...
  constructor(adminForm: FormBuilder, public http:HttpClient, public roleUpdateService : RoleUpdateService) {
  ...
  updateRole() {
    if (this.form.valid && this.form.value.email !== 'admin@gmail.com') {
      this.roleUpdateService.updateRole(this.form.value.email, this.form.value.role).subscribe((result : any) => {
